...
int LineNumbers::lineCount() const { return m_lineCount; }
...
float LineNumbers::lineHeight() const { return m_lineHeight; }

int LineNumbers::cursorPosition() const { return m_cursorPos; }
int LineNumbers::selectionStart() const { return m_selStart; }
int LineNumbers::selectionEnd() const { return m_selEnd; }
