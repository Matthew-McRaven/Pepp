...
//  For some reason, ColumnLayout must be wrapped with an item of
//  width changes do not propogate to parent control.
Item {
    id: root
        ...
        TabBar {
            ...
            TabButton {
                ...
                contentItem: Text {
                    ...
                    color: palette.text //  Use underline to flag active tab
                }
