...
struct LinearIR {
  ...
  // Number of bytes of object code generated by this line when placed at a specific address.
  // Default implementation returns 0.
  virtual quint16 object_size(quint16 base_address) const;
...
struct MonadicInstruction : public AddressableLine {
  ...
  const attr::AAttribute *attribute(attr::Type type) const override;
  void insert(std::unique_ptr<attr::AAttribute> attr) override;
  quint16 object_size(quint16 base_address) const override;
