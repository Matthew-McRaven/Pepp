...
sim::api2::memory::Result readRegister(sim::api2::memory::Target<Address> *target, ::isa::Pep9::Register reg,
...
template <typename Address>
sim::api2::memory::Result writeRegister(sim::api2::memory::Target<Address> *target, ::isa::Pep9::Register reg,
                                        quint16 value, sim::api2::memory::Operation op) {
  if (bits::hostOrder() != bits::Order::BigEndian) value = bits::byteswap(value);
...
template <typename Address>
sim::api2::memory::Result readCSR(sim::api2::memory::Target<Address> *target, ::isa::Pep9::CSR csr, bool &value,
                                  sim::api2::memory::Operation op) {
  return target->read(static_cast<quint8>(csr), {reinterpret_cast<quint8 *>(&value), 1}, op);
}

template <typename Address>
sim::api2::memory::Result writeCSR(sim::api2::memory::Target<Address> *target, ::isa::Pep9::CSR csr, bool value,
                                   sim::api2::memory::Operation op) {
