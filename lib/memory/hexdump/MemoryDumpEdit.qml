...
Item {
    ...
    signal startEditing
    //  Indicates start of edit mode
    signal finishEditing(bool save)
    //  Indicates end of edit mode
    signal directionKey(int key)

    //  Indicates that user overflowed control
    ...
    Rectangle {
        ...
        TextInput {
            ...
            validator: RegularExpressionValidator {
                regularExpression: /[0-9,A-F,a-f]{2}/
            }
            ...
            Keys.onPressed: event => {
                                ...
                                if (isMoving) {
                                    ...
                                    console.log(
                                        "editor.keys (before): pos,start,end="
