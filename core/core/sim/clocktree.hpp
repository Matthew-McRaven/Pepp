...
struct IdealClock : public Device, public ClockSource {
  IdealClock(Device::Configuration desc, Device::ID id, u64 period)
...
struct ScaledClock : public Device, public ClockSource {
  ...
  ScaledClock(Device::Configuration desc, Device::ID id, std::shared_ptr<ClockSource> parent, float period_scale,
...
struct MuxClock : public Device, public ClockSource {
  ...
  explicit MuxClock(Device::Configuration desc, Device::ID id, Choices &&...choices)
