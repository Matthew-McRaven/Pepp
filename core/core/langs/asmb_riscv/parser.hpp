...
private:
  ...
  std::shared_ptr<pepp::tc::RTypeIR> r_type(std::string_view name, riscv::MnemonicDescriptor desc);
  std::shared_ptr<pepp::tc::ITypeIR> i_type_load(std::string_view name, riscv::MnemonicDescriptor desc);
  std::shared_ptr<pepp::tc::ITypeIR> i_type_arith(std::string_view name, riscv::MnemonicDescriptor desc);
  std::shared_ptr<pepp::tc::STypeIR> s_type(std::string_view name, riscv::MnemonicDescriptor desc);
  std::shared_ptr<pepp::tc::BTypeIR> b_type(std::string_view name, riscv::MnemonicDescriptor desc);
  std::shared_ptr<pepp::tc::JTypeIR> j_type(std::string_view name, riscv::MnemonicDescriptor desc);
  std::shared_ptr<pepp::tc::UTypeIR> u_type(std::string_view name, riscv::MnemonicDescriptor desc);
