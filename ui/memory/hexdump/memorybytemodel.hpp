...
class FRONTEND_EXPORT MemoryByteModel : public QAbstractTableModel {
  Q_OBJECT
...
public:
  ...
  Q_INVOKABLE void clearSelected(const QModelIndex &index,
                                 const RoleNames type = Selected);
  Q_INVOKABLE QVariant setSelected(const QModelIndex &index,
                                   const RoleNames type = Selected);
...
private:
  ...
  QVariant selected(const QModelIndex &index,
                    const RoleNames type = Selected) const;
  // QVariant setSelected(const QModelIndex& index,const RoleNames type =
  // Selected); void clearSelected(const QModelIndex& index, const RoleNames
  // type = Selected);
