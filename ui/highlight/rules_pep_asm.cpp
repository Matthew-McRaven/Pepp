...
const auto symbol_re =
    QRegularExpression(identifier_str + u"(?=:)"_qs, QRegularExpression::PatternOption::CaseInsensitiveOption);
...
const auto warning_re =
    QRegularExpression(";WARNING:[\\s].*$", QRegularExpression::PatternOption::CaseInsensitiveOption);
...
QList<highlight::Rule> highlight::rules_pep10_asm() {
  ...
  rules.append(
      {QRegularExpression(u"@"_qs + identifier_str + "\\b", QRegularExpression::PatternOption::CaseInsensitiveOption),
       style::Types::Dot});
