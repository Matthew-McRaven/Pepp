...
QFont::Weight Style::getWeight() const
{
    return m_weight;
}
...
{
    return this->m_font == other.m_font && this->m_color == other.m_color
        && this->m_background == other.m_background && this->m_italics == other.m_italics
