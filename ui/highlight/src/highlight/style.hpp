...
namespace highlight{
class HIGHLIGHT_EXPORT Style : public QObject
{
    Q_OBJECT
    ...
    Q_PROPERTY(bool italics READ getItalics WRITE setItalics NOTIFY italicsChanged);
    Q_PROPERTY(QFont::Weight weight READ getWeight WRITE setWeight NOTIFY weightChanged);
public:
