...
Item {
    ...
    Component.onCompleted: {
        ...
        userAsmEdit.editor.modifyBP.connect(project.onModifyUserSourceBP)
        osAsmEdit.editor.modifyBP.connect(project.onModifyOSSourceBP)
        userList.editor.modifyBP.connect(project.onModifyUserListBP)
        osList.editor.modifyBP.connect(project.onModifyOSListBP)
        project.modifyUserSourceBP.connect(userAsmEdit.editor.onModifyBP)
    ...
    Component.onDestruction: {
        ...
        userAsmEdit.editor.modifyBP.disconnect(project.onModifyUserSourceBP)
        osAsmEdit.editor.modifyBP.disconnect(project.onModifyOSSourceBP)
        userList.editor.modifyBP.disconnect(project.onModifyUserListBP)
        osList.editor.modifyBP.disconnect(project.onModifyOSListBP)
        project.modifyUserSourceBP.disconnect(userAsmEdit.editor.onModifyBP)
