...
SCINTILLA_EXPORT void DrawWrapMarker(Surface *surface, PRectangle rcPlace, bool isEndMarker, ColourRGBA wrapColour);
 ...
 */
class SCINTILLA_EXPORT MarginView {
public:
  ...
  void PaintMargin(Surface *surface, Sci::Line topLine, PRectangle rc, PRectangle rcMargin, const EditModel &model,
                   const ViewStyle &vs);
};
} // namespace Scintilla::Internal
