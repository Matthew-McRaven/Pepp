...
class SCINTILLA_EXPORT AutoComplete {
  bool active;
...
public:
   ...
   *  Ordering::Custom:      Handle non-alphabetical entries; start up performance cost for generating a sorted lookup
   * table
   */
  ...
  void Start(Window &parent, int ctrlID, Sci::Position position, Point location, Sci::Position startLen_,
             int lineHeight, bool unicodeMode, Scintilla::Technology technology, ListOptions listOptions);
