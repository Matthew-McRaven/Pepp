...
class LexState;
class SCINTILLA_EXPORT ScintillaBase : public Editor, IListBoxDelegate {
protected:
  ...
  void AutoCompleteNotifyCompleted(char ch, CompletionMethods completionMethod, Sci::Position firstPos,
                                   const char *text);
