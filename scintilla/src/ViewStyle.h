...
class SCINTILLA_EXPORT MarginStyle {
public:
...
class SCINTILLA_EXPORT FontRealised {
public:
  FontMeasurements measurements;
  std::shared_ptr<Font> font;
  void Realise(Surface &surface, int zoomLevel, Scintilla::Technology technology, const FontSpecification &fs,
...
struct SCINTILLA_EXPORT SelectionAppearance {
...
struct SCINTILLA_EXPORT CaretLineAppearance {
  // Whether to draw on base layer or over text
  Scintilla::Layer layer = Layer::Base;
...
struct SCINTILLA_EXPORT CaretAppearance {
...
struct SCINTILLA_EXPORT WrapAppearance {
...
struct SCINTILLA_EXPORT EdgeProperties {
  int column = 0;
  ColourRGBA colour;
...
/**
 */
class SCINTILLA_EXPORT ViewStyle {
