...
SCINTILLA_EXPORT inline int operator<<(int i, MarkerOutline marker) noexcept { return i << static_cast<int>(marker); }

// Functions to manipulate fields from a FindOption

SCINTILLA_EXPORT constexpr FindOption operator|(FindOption a, FindOption b) noexcept {
  return static_cast<FindOption>(static_cast<int>(a) | static_cast<int>(b));
}

SCINTILLA_EXPORT inline FindOption &operator|=(FindOption &self, FindOption a) noexcept {
  self = self | a;
  return self;
}
...
SCINTILLA_EXPORT constexpr FoldLevel operator&(FoldLevel lhs, FoldLevel rhs) noexcept {
  return static_cast<FoldLevel>(static_cast<int>(lhs) & static_cast<int>(rhs));
}

SCINTILLA_EXPORT constexpr FoldLevel LevelNumberPart(FoldLevel level) noexcept { return level & FoldLevel::NumberMask; }

SCINTILLA_EXPORT constexpr int LevelNumber(FoldLevel level) noexcept {
  return static_cast<int>(LevelNumberPart(level));
}

SCINTILLA_EXPORT constexpr bool LevelIsHeader(FoldLevel level) noexcept {
  return (level & FoldLevel::HeaderFlag) == FoldLevel::HeaderFlag;
}

SCINTILLA_EXPORT constexpr bool LevelIsWhitespace(FoldLevel level) noexcept {
  return (level & FoldLevel::WhiteFlag) == FoldLevel::WhiteFlag;
}

// Functions to manipulate fields from a FoldFlag

SCINTILLA_EXPORT constexpr FoldFlag operator|(FoldFlag a, FoldFlag b) noexcept {
  return static_cast<FoldFlag>(static_cast<int>(a) | static_cast<int>(b));
}

// Functions to manipulate fields from a FontQuality

SCINTILLA_EXPORT constexpr FontQuality operator&(FontQuality a, FontQuality b) noexcept {
  return static_cast<FontQuality>(static_cast<int>(a) & static_cast<int>(b));
}

// Functions to manipulate fields from a DocumentOption

SCINTILLA_EXPORT constexpr DocumentOption operator|(DocumentOption a, DocumentOption b) noexcept {
  return static_cast<DocumentOption>(static_cast<int>(a) | static_cast<int>(b));
}

// Functions to manipulate fields from a CaretPolicy

SCINTILLA_EXPORT constexpr CaretPolicy operator|(CaretPolicy a, CaretPolicy b) noexcept {
  return static_cast<CaretPolicy>(static_cast<int>(a) | static_cast<int>(b));
}

// Functions to manipulate fields from a CaretStyle

SCINTILLA_EXPORT constexpr CaretStyle operator|(CaretStyle a, CaretStyle b) noexcept {
...
SCINTILLA_EXPORT constexpr LineEndType operator&(LineEndType a, LineEndType b) noexcept {
...
SCINTILLA_EXPORT constexpr RepresentationAppearance operator|(RepresentationAppearance a,
...
SCINTILLA_EXPORT constexpr LineCharacterIndexType operator|(LineCharacterIndexType a,
...
SCINTILLA_EXPORT constexpr ModificationFlags operator|(ModificationFlags a, ModificationFlags b) noexcept {
...
SCINTILLA_EXPORT inline ModificationFlags &operator|=(ModificationFlags &self, ModificationFlags a) noexcept {
  self = self | a;
  return self;
}
...
SCINTILLA_EXPORT constexpr Update operator|(Update a, Update b) noexcept {
  return static_cast<Update>(static_cast<int>(a) | static_cast<int>(b));
}

// Functions to manipulate fields from a KeyMod

SCINTILLA_EXPORT constexpr KeyMod operator|(KeyMod a, KeyMod b) noexcept {
...
SCINTILLA_EXPORT constexpr KeyMod ModifierFlags(bool shift, bool ctrl, bool alt, bool meta = false,
...
template <typename T> SCINTILLA_EXPORT constexpr bool FlagSet(T value, T test) {
