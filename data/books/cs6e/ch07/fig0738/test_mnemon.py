...
def test_is_unary():
    ...
    assert Mnemonics.NEG.is_unary()
    assert Mnemonics.ABS.is_unary()
    assert not Mnemonics.SET.is_unary()
    assert not Mnemonics.STOP.is_unary()
    assert not Mnemonics.END.is_unary()
...
def test_is_nonunary():
    ...
    assert not Mnemonics.NEG.is_nonunary()
    assert not Mnemonics.ABS.is_nonunary()
