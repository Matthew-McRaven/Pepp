...
void inner(isa::Pep10::Mnemonic op) {
  ...
  for (quint16 opspec = 0; static_cast<quint32>(opspec) + 1 < quint32(0x1'0000); opspec++) {
    ...
    targets::isa::writeRegister<isa::Pep10>(cpu->regs(), isa::Pep10::Register::SP, 0xFFFF, rw);
    targets::isa::writeRegister<isa::Pep10>(cpu->regs(), isa::Pep10::Register::PC, 0x1122, rw);
