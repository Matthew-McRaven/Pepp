...
void smoke_unary(isa::Pep9::Mnemonic op) {
  ...
  REQUIRE_NOTHROW(targets::pep9::isa::writePackedCSR(cpu->csrs(), truth[0], rw));
  tmp = bits::hostOrder() != bits::Order::BigEndian ? bits::byteswap(*(quint16 *)(truth + 1)) : *(quint16 *)(truth + 1);
  REQUIRE_NOTHROW(targets::pep9::isa::writeRegister(cpu->regs(), isa::Pep9::Register::A, tmp, rw));
  tmp = bits::hostOrder() != bits::Order::BigEndian ? bits::byteswap(*(quint16 *)(truth + 3)) : *(quint16 *)(truth + 3);
  REQUIRE_NOTHROW(targets::pep9::isa::writeRegister(cpu->regs(), isa::Pep9::Register::X, tmp, rw));
  tmp = bits::hostOrder() != bits::Order::BigEndian ? bits::byteswap(*(quint16 *)(truth + 7)) : *(quint16 *)(truth + 7);
  REQUIRE_NOTHROW(targets::pep9::isa::writeRegister(cpu->regs(), isa::Pep9::Register::SP, tmp, rw));
