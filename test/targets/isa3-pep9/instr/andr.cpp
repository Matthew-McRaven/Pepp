...
TEST_CASE("Pep9::Mnemonic::ANDA", "[scope:targets][kind:int][target:pep9]") {
  using Register = isa::Pep9::Register;
  inner<Register::A, Register::X>(isa::Pep9::Mnemonic::ANDA);
}
TEST_CASE("Pep9::Mnemonic::ANDX", "[scope:targets][kind:int][target:pep9]") {
  using Register = isa::Pep9::Register;
  inner<Register::X, Register::A>(isa::Pep9::Mnemonic::ANDX);
}
