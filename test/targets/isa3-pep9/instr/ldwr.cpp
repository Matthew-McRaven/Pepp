...
TEST_CASE("Pep9::Mnemonic::LDWA", "[scope:targets][kind:int][target:pep9]") {
  using Register = isa::Pep9::Register;
  inner<Register::A, Register::X>(isa::Pep9::Mnemonic::LDWA);
}
TEST_CASE("Pep9::Mnemonic::LDWX", "[scope:targets][kind:int][target:pep9]") {
  using Register = isa::Pep9::Register;
  inner<Register::X, Register::A>(isa::Pep9::Mnemonic::LDWX);
}
