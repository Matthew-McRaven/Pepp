...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    components::storage::Range<offset_t, enable_history, val_size_t>::Range(offset_t max_offset,
                                                                            val_size_t default_value)
requires(enable_history)
    : components::storage::Base<offset_t, enable_history, val_size_t>(max_offset), _default(default_value),
      _storage({}), _delta(std::make_unique<components::delta::Vector<offset_t, val_size_t>>(*this)) {}
...
template <typename offset_t, bool enable_history, typename val_size_t>
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    result<val_size_t> components::storage::Range<offset_t, enable_history, val_size_t>::get(offset_t offset)
const {
    ...
    if (offset > this->_max_offset)
        ...
        for (auto &span : _storage) {
            if (auto dist = offset - std::get<0>(span.span); dist <= std::get<1>(span.span) - std::get<0>(span.span)) {
...
template <typename offset_t, bool enable_history, typename val_size_t>
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    result<void> components::storage::Range<offset_t, enable_history, val_size_t>::set(offset_t offset,
                                                                                       val_size_t value) {
    if (offset > this->_max_offset)
    ...
    for (auto &span : _storage) {
        if (auto dist = offset - std::get<0>(span.span);
            offset >= std::get<0>(span.span) && dist <= std::get<1>(span.span) - std::get<0>(span.span)) {
    ...
    if (!inserted) {
        ...
        std::sort(_storage.begin(), _storage.end(),
                  [](auto lhs, auto rhs) { return std::get<0>(lhs.span) < std::get<0>(rhs.span); });
        check_merge = true;
    }
...
template <typename offset_t, bool enable_history, typename val_size_t>
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    result<val_size_t> components::storage::Range<offset_t, enable_history, val_size_t>::read(offset_t offset)
const {
...
template <typename offset_t, bool enable_history, typename val_size_t>
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    result<void> components::storage::Range<offset_t, enable_history, val_size_t>::write(offset_t offset,
                                                                                         val_size_t value) {
    if constexpr (enable_history) {
...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<
         val_size_t>) bool components::storage::Range<offset_t, enable_history, val_size_t>::deltas_enabled() const {
...
template <typename offset_t, bool enable_history, typename val_size_t>
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    result<std::unique_ptr<components::delta::Base<offset_t, val_size_t>>> components::storage::Range<
