...
template <typename address_size_t>
masm::ir::comment_line<address_size_t> &
masm::ir::comment_line<address_size_t>::operator=(masm::ir::comment_line<address_size_t> other) {
    swap(*this, other);
    return *this;
}
...
template <typename address_size_t>
masm::ir::blank_line<address_size_t> &
masm::ir::blank_line<address_size_t>::operator=(masm::ir::blank_line<address_size_t> other) {
    swap(*this, other);
    return *this;
}
...
template <typename address_size_t> std::string masm::ir::blank_line<address_size_t>::generate_listing_string() const {
    return {};
}

template <typename address_size_t> std::string masm::ir::blank_line<address_size_t>::generate_source_string() const {
    return {};
}
