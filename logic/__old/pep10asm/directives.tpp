...
template <typename address_size_t>
masm::ir::dot_input<address_size_t> &masm::ir::dot_input<address_size_t>::operator=(
	masm::ir::dot_input<address_size_t> other)
{
    swap(*this, other);
    return *this;
}
...
template <typename address_size_t>
std::string masm::ir::dot_input<address_size_t>::generate_listing_string() const
{
	auto temp = fmt::format("{:<6} {:<6}{}",
		"",
		"",
...
template <typename address_size_t>
std::string masm::ir::dot_input<address_size_t>::generate_source_string() const
{
...
template <typename address_size_t>
bool masm::ir::dot_input<address_size_t>::tracks_trace_tags() const
{
	return false;
}
...
template <typename address_size_t>
masm::ir::dot_output<address_size_t> &masm::ir::dot_output<address_size_t>::operator=(
	masm::ir::dot_output<address_size_t> other)
{
    swap(*this, other);
    return *this;
}
...
template <typename address_size_t>
std::string masm::ir::dot_output<address_size_t>::generate_listing_string() const
{
	auto temp = fmt::format("{:<6} {:<6}{}",
		"",
		"",
...
template <typename address_size_t>
std::string masm::ir::dot_output<address_size_t>::generate_source_string() const
{
...
template <typename address_size_t>
bool masm::ir::dot_output<address_size_t>::tracks_trace_tags() const
{
	return false;
}
