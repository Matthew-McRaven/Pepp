...
template <typename address_size_t> class lir_argument {
  public:
...
template <typename address_size_t> class char_argument : public lir_argument<address_size_t> {
  public:
...
template <typename address_size_t> class dec_argument : public lir_argument<address_size_t> {
  public:
...
template <typename address_size_t> class unsigned_dec_argument : public lir_argument<address_size_t> {
...
template <typename address_size_t> class hex_argument : public lir_argument<address_size_t> {
  public:
...
template <typename address_size_t> class string_argument : public lir_argument<address_size_t> {
  public:
...
template <typename address_size_t> class ascii_argument : public lir_argument<address_size_t> {
  public:
...
template <typename address_size_t> class symbol_ref_argument : public lir_argument<address_size_t> {
  public:
