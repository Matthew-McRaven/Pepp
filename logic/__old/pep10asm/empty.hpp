...
template <typename address_size_t> class comment_line : public masm::ir::linear_line<address_size_t> {
  public:
...
template <typename address_size_t> class blank_line : public masm::ir::linear_line<address_size_t> {
  public:
    blank_line() = default;
