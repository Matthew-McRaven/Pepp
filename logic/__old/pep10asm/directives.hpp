...
template <typename address_size_t> class dot_address : public masm::ir::linear_line<address_size_t> {
  public:
    dot_address() = default;
...
template <typename address_size_t> class dot_align : public masm::ir::linear_line<address_size_t> {
  public:
...
template <typename address_size_t> class dot_ascii : public masm::ir::linear_line<address_size_t> {
  public:
    dot_ascii();
...
template <typename address_size_t> class dot_block : public masm::ir::linear_line<address_size_t> {
  public:
    dot_block();
...
template <typename address_size_t> class dot_burn : public masm::ir::linear_line<address_size_t> {
  public:
    dot_burn() = default;
...
template <typename address_size_t> class dot_byte : public masm::ir::linear_line<address_size_t> {
  public:
    dot_byte();
...
template <typename address_size_t> class dot_end : public masm::ir::linear_line<address_size_t> {
  public:
    dot_end() = default;
...
template <typename address_size_t> class dot_equate : public masm::ir::linear_line<address_size_t> {
  public:
    dot_equate() = default;
...
template <typename address_size_t> class dot_input : public masm::ir::linear_line<address_size_t> {
  public:
    dot_input() = default;
...
template <typename address_size_t> class dot_output : public masm::ir::linear_line<address_size_t> {
  public:
    dot_output() = default;
...
template <typename address_size_t> class dot_word : public masm::ir::linear_line<address_size_t> {
  public:
    dot_word();
