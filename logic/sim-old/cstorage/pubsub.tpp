...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    components::storage::Channel<offset_t, val_size_t>::Event::Event(val_size_t value, publisher_id_t publisher,
                                                                     bool empty, std::shared_ptr<Event> prev_node,
                                                                     size_t displacement)
...
template <typename offset_t, typename val_size_t>
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    components::storage::Channel<offset_t, val_size_t>::Endpoint::Endpoint(std::shared_ptr<const Event> event,
                                                                           publisher_id_t id,
...
template <typename offset_t, typename val_size_t>
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    std::shared_ptr<typename components::storage::Channel<offset_t, val_size_t>::Endpoint> components::storage::Channel<
        offset_t, val_size_t>::Endpoint::clone()
const {
...
template <typename offset_t, typename val_size_t>
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    std::optional<val_size_t> components::storage::Channel<offset_t, val_size_t>::Endpoint::current_value()
const { return this->event->value; }

template <typename offset_t, typename val_size_t>
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>) std::size_t
    components::storage::Channel<offset_t, val_size_t>::Endpoint::event_id()
const { return reinterpret_cast<std::size_t>((void *)this->event.get()); }
...
template <typename offset_t, typename val_size_t>
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    std::optional<val_size_t> components::storage::Channel<offset_t, val_size_t>::Endpoint::next_value()
const {
...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>) void components::
    storage::Channel<offset_t, val_size_t>::Endpoint::append_value(val_size_t new_value) {
...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    std::shared_ptr<typename components::storage::Channel<offset_t, val_size_t>::Endpoint> components::storage::Channel<
        offset_t, val_size_t>::new_endpoint() {
    return std::make_shared<Endpoint>(tail, this->next_id++, this->shared_from_this());
}

template <typename offset_t, typename val_size_t>
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    std::shared_ptr<const typename components::storage::Channel<offset_t, val_size_t>::Event> components::storage::
...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    ...
    while (ptr->prev_node && ptr->publisher != publisher)
        ptr = ptr->prev_node;
...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    std::shared_ptr<const typename components::storage::Channel<offset_t, val_size_t>::Event> components::storage::
        Channel<offset_t, val_size_t>::event_at(size_t time)
const {
    // No event can have a timestamp higher than the distance between the tail and head.
    if (time > tail->displacement)
        return nullptr;
    auto ptr = head;
    while (ptr->displacement != time)
        ptr = ptr->next_node;
    return ptr;
}
...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    std::shared_ptr<const typename components::storage::Channel<offset_t, val_size_t>::Event> components::storage::
        Channel<offset_t, val_size_t>::next_event(std::shared_ptr<const Event> event)
const {
    // If there is no subsequent event, then return the current event.
    if (event->next_node == nullptr)
        return event;
...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    std::shared_ptr<const typename components::storage::Channel<offset_t, val_size_t>::Event> components::storage::
        Channel<offset_t, val_size_t>::next_event(size_t time)
const {
...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    std::shared_ptr<const typename components::storage::Channel<offset_t, val_size_t>::Event> components::storage::
        Channel<offset_t, val_size_t>::previous_event(std::shared_ptr<const Event> event)
const {
    // If there is no subsequent event, then return the current event.
    if (event->prev_node == nullptr)
        return event;
    // Otherwise traverse the list, continuing over empty nodes.
...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    std::shared_ptr<const typename components::storage::Channel<offset_t, val_size_t>::Event> components::storage::
        Channel<offset_t, val_size_t>::previous_event(size_t time)
const {
...
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    std::shared_ptr<const typename components::storage::Channel<offset_t, val_size_t>::Event> components::storage::
        Channel<offset_t, val_size_t>::latest_event()
const { return tail; }
...
template <typename offset_t, typename val_size_t>
requires(components::storage::UnsignedIntegral<offset_t> &&components::storage::Integral<val_size_t>)
    std::shared_ptr<typename components::storage::Channel<offset_t, val_size_t>::Event> components::storage::Channel<
        offset_t, val_size_t>::mutable_event_at(size_t time) {
    // No event can have a timestamp higher than the distance between the tail and head.
    if (time > tail->displacement)
        return nullptr;
    auto ptr = head;
