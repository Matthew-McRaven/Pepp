  ...
  void smoke_data() {
    ...
    for (auto &figure : figures) {
      if (!figure->typesafeElements().contains("pep"))
        ...
        continue;
      auto user = figure->typesafeElements()["pep"]->contents;
