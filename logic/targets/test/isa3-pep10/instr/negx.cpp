...
class ISA3Pep10_NEGX : public QObject {
  Q_OBJECT
private slots:
  void u() {
    ...
    auto program = std::array<quint8, 1>{(quint8)isa::Pep10::Mnemonic::NEGX};
    ...
    QCOMPARE(rreg(isa::Pep10::Register::IS),
             (quint8)isa::Pep10::Mnemonic::NEGX);
