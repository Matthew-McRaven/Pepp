...
class ISA3Pep10_STBX : public QObject {
  Q_OBJECT
private slots:
  void i() {
    ...
    auto program = std::array<quint8, 3>{
        1+(quint8) isa::Pep10::Mnemonic::STBX,static_cast<uint8_t>((opspec >> 8) & 0xff),
    ...
    QCOMPARE(rreg(isa::Pep10::Register::IS), 1+(quint8)isa::Pep10::Mnemonic::STBX);
