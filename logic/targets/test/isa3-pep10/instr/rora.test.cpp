...
class ISA3Pep10_RORA : public QObject {
  Q_OBJECT
private slots:
  void u() {
    ...
    auto program = std::array<quint8, 1>{(quint8) isa::Pep10::Mnemonic::RORA};
    ...
    QCOMPARE(rreg(isa::Pep10::Register::IS), (quint8) isa::Pep10::Mnemonic::RORA);
...
#include "rora.test.moc"

QTEST_MAIN(ISA3Pep10_RORA)
