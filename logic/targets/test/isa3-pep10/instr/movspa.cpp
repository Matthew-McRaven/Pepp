...
class ISA3Pep10_MOVSPA : public QObject {
  Q_OBJECT
private slots:
  void u() {
    ...
    QCOMPARE(rreg(isa::Pep10::Register::IS), (quint8) isa::Pep10::Mnemonic::MOVSPA);
    // OS loaded the Mem[0x0001-0x0002].
    QCOMPARE(rreg(isa::Pep10::Register::OS), 0);
    // Check that target register had arithmetic performed.
    QCOMPARE(rreg(isa::Pep10::Register::SP), target);
  }
  void u_data() {
