...
template<isa::Pep10::Register target_reg, isa::Pep10::Register other_reg>
void inner(isa::Pep10::Mnemonic op)
{
    ...
    for (uint16_t opspec = 0; static_cast<uint32_t>(opspec) + 1 < 0x1'0000; opspec++) {
        ...
        auto program = std::array<quint8, 3>{(quint8) op,
...
TEST_CASE("LDBA, i", "[pep10][isa]")
{
    using Register = isa::Pep10::Register;
    inner<Register::A, Register::X>(isa::Pep10::Mnemonic::LDBA);
}
TEST_CASE("LDBX, i", "[pep10][isa]")
{
    using Register = isa::Pep10::Register;
    inner<Register::X, Register::A>(isa::Pep10::Mnemonic::LDBX);
}
