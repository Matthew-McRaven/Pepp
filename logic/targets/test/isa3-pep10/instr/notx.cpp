...
class ISA3Pep10_NOTX : public QObject {
  Q_OBJECT
private slots:
  void u() {
    ...
    auto endRegVal = static_cast<quint16>(~target);

    // Object code for instruction under test.
    auto program = std::array<quint8, 1>{(quint8)isa::Pep10::Mnemonic::NOTX};
    ...
    QCOMPARE(rreg(isa::Pep10::Register::IS),
             (quint8)isa::Pep10::Mnemonic::NOTX);
