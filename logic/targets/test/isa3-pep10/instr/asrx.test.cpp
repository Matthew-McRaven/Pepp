...
class ISA3Pep10_ASRX : public QObject {
  Q_OBJECT
private slots:
  void u() {
    ...
    auto program = std::array<quint8, 1>{0x17};
    ...
    QCOMPARE(rreg(isa::Pep10::Register::IS), 0x17);
...
#include "asrx.test.moc"

QTEST_MAIN(ISA3Pep10_ASRX)
