...
std::array<isa::pep10::addr_map, 256> init_mmap() {
  ...
  for (int it = 0; it < 256; it++) {
    ...
    case addressing_class::R_none:[[fallthrough]];
    case addressing_class::U_none:mode = addressing_mode::NONE;
      break;
    ...
    case addressing_class::AAA_i:
      ...
      break;
    case addressing_class::AAA_all:[[fallthrough]];
...
isa::pep10::addressing_mode isa::pep10::parse_addr_mode(std::string addr_mode) {
...
bool isa::pep10::is_mnemonic_unary(instruction_mnemonic mnemon) {
  ...
  case addressing_class::AAA_i:
  case addressing_class::RAAA_all:
  case addressing_class::RAAA_noi:return false;
  case addressing_class::U_none:
  case addressing_class::R_none:return true;
...
uint8_t isa::pep10::opcode(instruction_mnemonic mn, addressing_mode addr) {
  ...
  if (addr_class == addressing_class::A_ix && addr == addressing_mode::X)
    ...
    switch (addr) {
    case addressing_mode::I:offset = 0;
      break;
    case addressing_mode::D:offset = 1;
      break;
    case addressing_mode::N:offset = 2;
      break;
    case addressing_mode::S:offset = 3;
      break;
    case addressing_mode::SF:offset = 4;
      break;
    case addressing_mode::X:offset = 5;
      break;
    case addressing_mode::SX:offset = 6;
      break;
    case addressing_mode::SFX:offset = 7;
      break;
    default:throw std::invalid_argument("Invalid addressing mode");
    }
  }
  return base + offset;
}