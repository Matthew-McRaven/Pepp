...
private slots:
  void smoke(){
      ...
      auto actualListing = pas::ops::pepp::formatListing<pas::isa::Pep10ISA>(*parsed.root, 3);
      // FIXME: remove
  ...
  void smoke_data(){
    ...
    QTest::addRow("Blank") << "\n" << QStringList{"",""};
    QTest::addRow("Comment") << ";hello\n;world" << QStringList{"             ;hello","             ;world"};

    QTest::addRow("Unary") << "asla\nasra" << QStringList{"0000     14         ASLA","0001     16         ASRA"};
    QTest::addRow("Unary + symbol") << "abcdefg:asla" << QStringList{"0000     14 abcdefg: ASLA"};
    QTest::addRow("Nonunary non-br") << "adda 0xfaad,i\nsuba 0xbaad,sfx" << QStringList{"0000 A0FAAD         ADDA   0xFAAD, i", "0003 B7BAAD         SUBA   0xBAAD, sfx"};
    QTest::addRow("Nonunary br") << "br 10,i\nbr 20,x" << QStringList{"0000 1C000A         BR     10","0003 1D0014         BR     20, x"};

    QTest::addRow("ALIGN 1") << ".ALIGN 1" << QStringList{"0000                .ALIGN 1"};
    QTest::addRow("ALIGN 2 @ 0") << ".ALIGN 2" << QStringList{"0000                .ALIGN 2"};
    QTest::addRow("ALIGN 2 @ 1") << ".BYTE 1\n.ALIGN 2" << QStringList{"0000     01         .BYTE  1","0001     00         .ALIGN 2"};
    QTest::addRow("ALIGN 4 @ 0") << ".ALIGN 4" << QStringList{"0000                .ALIGN 4"};
    QTest::addRow("ALIGN 4 @ 1") << ".BYTE 1\n.ALIGN 4" << QStringList{"0000     01         .BYTE  1","0001 000000         .ALIGN 4"};
