...
private slots:
  ...
  void size0Directives() {
    QFETCH(QString, body);
    auto ret = pas::driver::pepp::createParser<isa::Pep10, pas::driver::BoostParserTag>(false)(
  ...
  void macro() {
    ...
    auto ret = pas::ops::generic::includeMacros(
        *res.root, pas::driver::pepp::createParser<isa::Pep10, pas::driver::BoostParserTag>(true), registry);
    QVERIFY(ret);
  ...
  void empty() {
    auto ret = pas::driver::pepp::createParser<isa::Pep10, pas::driver::BoostParserTag>(false)(u"\n\n\n"_qs,
                                                                  nullptr);
    QVERIFY(!ret.hadError);
    auto children = ret.root->get<pas::ast::generic::Children>().value;
