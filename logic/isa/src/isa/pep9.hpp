...
constexpr std::array<Opcode, 256> initOpcodes() {
    ...
    ret[(quint8)M::STOP] = {
                 .instr = {.mnemon = M::STOP, .type = T::U_none, .unary = true},
                 .mode = AM::NONE,
                 .valid = true};
    ret[(quint8)M::RET] = {
                            ...
                            .valid = true};
    ret[(quint8)M::RETTR] = {
                             .instr = {.mnemon = M::RETTR, .type = T::U_none, .unary = 1},
                             .mode = AM::NONE,
                             .valid = true};
    ret[(quint8)M::MOVSPA] = {
    ...
    // Add unary traps
    ret[(quint8)M::NOP0] = {
                             .instr = {.mnemon = M::NOP0, .type = T::R_none, .unary = 1},
                             .mode = AM::NONE,
                             .valid = true};
    ret[(quint8)M::NOP1] = {
                             .instr = {.mnemon = M::NOP1, .type = T::R_none, .unary = 1},
                             .mode = AM::NONE,
                             .valid = true};
