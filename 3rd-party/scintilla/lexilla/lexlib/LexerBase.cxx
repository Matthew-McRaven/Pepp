...
LexerBase::LexerBase(const LexicalClass *lexClasses_, size_t nClasses_) : lexClasses(lexClasses_), nClasses(nClasses_) {
  for (int wl = 0; wl < numWordLists; wl++) keyWordLists[wl] = new WordList;
...
int SCI_METHOD LexerBase::Version() const { return Scintilla::lvRelease5; }
...
const char *SCI_METHOD LexerBase::PropertyGet(const char *key) { return props.Get(key); }
...
void *SCI_METHOD LexerBase::PrivateCall(int, void *) { return nullptr; }

int SCI_METHOD LexerBase::LineEndTypesSupported() { return SC_LINE_END_TYPE_DEFAULT; }

int SCI_METHOD LexerBase::AllocateSubStyles(int, int) { return -1; }

int SCI_METHOD LexerBase::SubStylesStart(int) { return -1; }

int SCI_METHOD LexerBase::SubStylesLength(int) { return 0; }

int SCI_METHOD LexerBase::StyleFromSubStyle(int subStyle) { return subStyle; }

int SCI_METHOD LexerBase::PrimaryStyleFromStyle(int style) { return style; }

void SCI_METHOD LexerBase::FreeSubStyles() {}

void SCI_METHOD LexerBase::SetIdentifiers(int, const char *) {}

int SCI_METHOD LexerBase::DistanceToSecondaryStyles() { return 0; }

const char *SCI_METHOD LexerBase::GetSubStyleBases() { return styleSubable; }

int SCI_METHOD LexerBase::NamedStyles() { return static_cast<int>(nClasses); }
...
const char *SCI_METHOD LexerBase::GetName() { return ""; }

int SCI_METHOD LexerBase::GetIdentifier() { return SCLEX_AUTOMATIC; }
