...
class LEXILLA_EXPORT IDocument {
public:
  ...
  virtual Sci_Position SCI_METHOD GetRelativePosition(Sci_Position positionStart,
                                                      Sci_Position characterOffset) const = 0;
...
class LEXILLA_EXPORT ILexer5 : public ILexer4 {
public:
