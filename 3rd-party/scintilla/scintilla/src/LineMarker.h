...
typedef void (*DrawLineMarkerFn)(Surface *surface, const PRectangle &rcWhole, const Font *fontForCharacter, int tFold,
                                 Scintilla::MarginType marginStyle, const void *lineMarker);

/**
 */
class SCINTILLA_EXPORT LineMarker {
public:
  ...
  void Draw(Surface *surface, const PRectangle &rcWhole, const Font *fontForCharacter, FoldPart part,
            Scintilla::MarginType marginStyle) const;
