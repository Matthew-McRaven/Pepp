 ...
 */
struct SCINTILLA_EXPORT MarkerHandleNumber {
  int handle;
  int number;
 ...
 */
class SCINTILLA_EXPORT MarkerHandleSet {
...
class SCINTILLA_EXPORT LineMarkers : public PerLine {
...
class SCINTILLA_EXPORT LineLevels : public PerLine {
...
class SCINTILLA_EXPORT LineState : public PerLine {
...
class SCINTILLA_EXPORT LineAnnotation : public PerLine {
...
class SCINTILLA_EXPORT LineTabstops : public PerLine {
