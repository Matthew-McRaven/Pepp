...
class SCINTILLA_EXPORT CaseFolder {
public:
  CaseFolder() = default;
...
class SCINTILLA_EXPORT CaseFolderTable : public CaseFolder {
protected:
  char mapping[256];
...
class SCINTILLA_EXPORT CaseFolderUnicode : public CaseFolderTable {
