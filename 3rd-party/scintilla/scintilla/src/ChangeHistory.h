...
struct SCINTILLA_EXPORT ChangeSpan {
  Sci::Position start;
  Sci::Position length;
  int edition;
  int count;
...
struct SCINTILLA_EXPORT EditionCount {
  int edition;
  int count;
  // Used in tests.
...
class SCINTILLA_EXPORT ChangeStack {
...
struct SCINTILLA_EXPORT ChangeLog {
...
class SCINTILLA_EXPORT ChangeHistory {
  ChangeLog changeLog;
