...
struct SCINTILLA_EXPORT Sci_CharacterRange {
  Sci_PositionCR cpMin;
  Sci_PositionCR cpMax;
};

struct SCINTILLA_EXPORT Sci_CharacterRangeFull {
  Sci_Position cpMin;
  Sci_Position cpMax;
};

struct SCINTILLA_EXPORT Sci_TextRange {
  struct Sci_CharacterRange chrg;
  char *lpstrText;
};

struct SCINTILLA_EXPORT Sci_TextRangeFull {
  struct Sci_CharacterRangeFull chrg;
  char *lpstrText;
};

struct SCINTILLA_EXPORT Sci_TextToFind {
  struct Sci_CharacterRange chrg;
  const char *lpstrText;
  struct Sci_CharacterRange chrgText;
};

struct SCINTILLA_EXPORT Sci_TextToFindFull {
  struct Sci_CharacterRangeFull chrg;
  const char *lpstrText;
...
struct SCINTILLA_EXPORT Sci_Rectangle {
  int left;
  int top;
  int right;
  int bottom;
...
struct SCINTILLA_EXPORT Sci_RangeToFormat {
  Sci_SurfaceID hdc;
...
struct SCINTILLA_EXPORT Sci_RangeToFormatFull {
  Sci_SurfaceID hdc;
  Sci_SurfaceID hdcTarget;
  struct Sci_Rectangle rc;
  struct Sci_Rectangle rcPage;
...
struct SCINTILLA_EXPORT Sci_NotifyHeader {
...
struct SCINTILLA_EXPORT SCNotification {
