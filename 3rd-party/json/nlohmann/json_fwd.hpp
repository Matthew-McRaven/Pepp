...
#else
#define NLOHMANN_JSON_NAMESPACE_VERSION                                                                                    NLOHMANN_JSON_NAMESPACE_VERSION_CONCAT(NLOHMANN_JSON_VERSION_MAJOR, NLOHMANN_JSON_VERSION_MINOR,                     \
...
#define NLOHMANN_JSON_NAMESPACE_END                                                                                        } /* namespace (inline namespace) NOLINT(readability/namespace) */                                                       } // namespace nlohmann
#endif
